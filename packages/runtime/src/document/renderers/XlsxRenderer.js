...
class XlsxRenderer {
    static async render(doc) {
        ...
        const contentHash = (0, crypto_1.createHash)('sha256').update(xlsxContent).digest('hex');
...
exports.XlsxRenderer = XlsxRenderer;
//# sourceMappingURL=XlsxRenderer.js.map